...
const fragmentShader = `
    ...
    void main() {
        ...
        vec4 colorR = texture2D(u_texture, uv + vec2(strength * u_aberrationIntensity * 0.00, 0.0));
        vec4 colorG = texture2D(u_texture, uv);
        vec4 colorB = texture2D(u_texture, uv - vec2(strength * u_aberrationIntensity * 0.00, 0.0));
...
const splitText = new SplitType(".about-copy h2", {
  types: "lines",
  lineClass: "line",
});
...
ScrollTrigger.create({
  ...
  start: "top center",
  onEnter: () => {
    gsap.to(".about-copy h2 .line span", {
      translateY: 0,
      duration: 1,
      stagger: 0.1,
      ease: "power3.out",
...
// const animateFooter = () => {
//   gsap.set(".footer-wrapper", { yPercent: -150 });
